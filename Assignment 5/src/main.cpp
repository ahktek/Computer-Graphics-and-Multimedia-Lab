...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        transform = glm::rotate(transform,(float)glfwGetTime(), glm::vec3(1.0f, 0.0f, 1.0f));//0, 0, 1) means rotate around the Z-axis, which is perpendicular to the screen.In 2D, this gives the impression of spinning in place.
